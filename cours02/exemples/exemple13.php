  ...
  <body>
    <?php
      if (!isset($_GET['mot1'])) {
        ...
        if (isset($_GET['mot3'])) {
          if ($_GET['mot1'] <= $_GET['mot2'] && $_GET['mot2'] <= $_GET['mot3']) {
            echo 'Les trois mots sont placés en ordre alphabétique.';
          } else {
            echo 'Les trois mots ne sont pas placés en ordre alphabétique.';
          }
        } else if ($_GET['mot1'] <= $_GET['mot2']) {
          echo 'Les deux mots sont placés en ordre alphabétique.';
        } else {
          echo 'Les deux mots ne sont pas placés en ordre alphabétique.';
        }
      }
    ?>
  </body>
